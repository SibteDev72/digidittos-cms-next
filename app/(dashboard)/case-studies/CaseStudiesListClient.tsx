...
export default function CaseStudiesListClient() {
  ...
  const fetchCaseStudies = useCallback(async () => {
    ...
    try {
      ...
      swalError("Failed to load case studies");
    } finally {
      setLoading(false);
    }
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      swalSuccess("Case study deleted!");
      fetchCaseStudies();
    } catch (err: unknown) {
                ...
                <tr key={cs._id} className="hover:bg-gray-50">
                  ...
                  <td className="relative px-4 py-3 text-right">
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        setOpenDropdown(openDropdown === cs._id ? null : cs._id);
                      }}
                    ...
                    {openDropdown === cs._id && (
                      <div className="absolute right-4 top-full z-30 mt-1 w-52 rounded-lg border border-gray-200 bg-white py-1 shadow-lg">
                        <button
                          onClick={() => { router.push(`/case-studies/${cs._id}/edit`); setOpenDropdown(null); }}
                        ...
                        <button
                          onClick={() => { router.push(`/case-studies/create`); setOpenDropdown(null); }}
                          className="flex w-full items-center gap-2.5 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50"
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4 text-gray-400">
                        ...
                        {cs.slug && (
                          <button
                            onClick={() => { navigator.clipboard.writeText(cs.slug); setOpenDropdown(null); }}
                            className="flex w-full items-center gap-2.5 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50"
                          >
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4 text-gray-400">
                        ...
                        <button
                          onClick={() => { setOpenDropdown(null); handleDelete(cs._id); }}
